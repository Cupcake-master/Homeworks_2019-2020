...
<form method="post" class="form-horizontal" autocomplete="off" id="form">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <select id="groups" name="groups" class="form-control" multiple="multiple" required="required">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="newGroup" name="newGroup" type="text" placeholder="Write a new group" class="form-control input-md" min="3" max="30">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="e-mail" name="e-mail" type="email" placeholder="Write e-mail" class="form-control input-md">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="password" name="password" type="password" placeholder="Write password" class="form-control input-md">
        ...
        <!-- Password input-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="re-password">Re-password:</label>
            <div class="col-md-4">
                <input id="re-password" name="re-password" type="password" placeholder="Write re-password" class="form-control input-md">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="date of birth" name="date of birth" type="date" placeholder="Write the date of birth" class="form-control input-md">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <select id="country" name="country" class="form-control" required="required">
                    ...
                    <option value="17">Baletia*</option>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <textarea style="width:400px; height:200px;" class="form-control" id="about myself" name="about myself" required="required">I like ...</textarea>
            </div>
        </div>
        ...
        <script>
            function validateForm() {
                ...
                let error = '';
                if (newGroup.length < 3 || newGroup.length > 30){
                    alert('newGroup must be between 6 and 30 characters!');
                }
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <button type="submit" id="enter" name="enter" class="btn btn-primary" onclick="validateForm()">Enter</button>
            </div>
        </div>
