    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <button id="Registration" name="Registration" class="btn btn-danger"><a class="text-white" href="http://localhost:8080/Entrance_war/registration">Registration</a></button>
            </div>
        </div>
