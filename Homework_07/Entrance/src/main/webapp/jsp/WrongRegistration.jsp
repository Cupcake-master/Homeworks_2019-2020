...
<form method="post" class="form-horizontal" autocomplete="off" action="/Entrance_war/WrongRegistration.jsp">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="re-password" name="re-password" type="password" placeholder="Write re-password" class="form-control input-md" required="required">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="phone" name="phone" type="tel" placeholder="Write telephone number" class="form-control input-md" required="required" pattern="^((8|\+7)[\- ]?)?(\(?\d{3}\)?[\- ]?)?[\d\- ]{7,10}$">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="date of birth" name="date of birth" type="date" placeholder="Write the date of birth" class="form-control input-md" required="required">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <button type="submit" id="enter" name="enter" class="btn btn-primary" ><a class="text-white" href="http://localhost:8080/Entrance_war/newMain">Enter</a></button>
            </div>
        </div>
