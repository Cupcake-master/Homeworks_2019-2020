...
public class CSVFile {
    ...
    public static void writeToCSVFile(String email, String password, String telephoneNumber, String dateOfBirth,
        ...
        try (FileWriter out = new FileWriter("C:\\Users\\sereg\\Desktop\\My_work\\Homework_on_2_course-practice\\" +
                "Homework_7\\Entrance\\src\\main\\java\\ru\\bulat\\data.csv");
    ...
    public static boolean userVerification(String email, String password) {
        try {
            Reader in = new FileReader("C:\\Users\\sereg\\Desktop\\My_work\\Homework_on_2_course-practice\\" +
                    "Homework_7\\Entrance\\src\\main\\java\\ru\\bulat\\data.csv");
